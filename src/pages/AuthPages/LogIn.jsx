    ...
    <div className="space-y-3 w-fit  items-center">
      ...
      <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4 relative">
            <div className="flex justify-between mb-2 items-center">
              ...
              <Link to="/auth/forgot-pass">
                <div className="link text-sm text-red-700  underline cursor-pointer hover:no-underline ">
                  Forgot password?
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center mt-4 justify-between">
              <label className="flex items-center gap-2 text-sm">
                ...
                />
                <span className="text-sm">Remember Letter</span>
              </label>
            </div>
        ...
        <div className="mt-4  sm:mb-4">
          <button
            className="bg-yellow-400 duration-500 text-black text-sm py-3 cursor-pointer flex gap-2 items-center rounded-full font-medium hover:bg-yellow-500 place-content-center w-full "
            type="submit"
          >
            Sign In
          </button>
