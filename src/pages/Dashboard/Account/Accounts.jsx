                                ...
                                <DialogHeader>
                                    ...
                                    >
                                        ...
                                        <div className="mb-1 w-full  sm:mb-2">
                                            ...
                                            <div className="mb-4 relative">
                                                <div className='flex justify-between mb-2 items-center'>
                                                    ...
                                                    <label className='text-sm items-start '>New email</label>
                                                </div>
                                                <input
                                        ...
                                        <div className="mt-4  sm:mb-4">
                                            ...
                                            <button className='bg-yellow-400 duration-500 text-black text-sm py-3 cursor-pointer flex gap-2 items-center rounded-full font-medium px-4 hover:bg-yellow-500 ' type="submit">
                                                Sign Up
                                            </button>
                                        </div>
                                    </form>
                                ...
                                <DialogHeader>
                                    ...
                                    >
                                        ...
                                        <div className="mt-4  sm:mb-4">
                                            ...
                                            <button className='bg-yellow-400 duration-500 text-black text-sm py-3 cursor-pointer flex gap-2 items-center rounded-full font-medium hover:bg-yellow-500 px-4' type="submit">
                                                Sign Up
                                            </button>
                                        </div>
                                    </form>
